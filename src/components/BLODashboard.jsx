...
const BLODashboard = () => {
  ...
  const requests = [
    { id: 'REQ001', type: 'Form 6 (New Voter)', name: 'Arjun Kumar', epic: 'Pending Generation', status: 'Reviewing' },
    { id: 'REQ002', type: 'Form 7 (Deletion)', name: 'Ramesh Patel', epic: 'TS9876543', status: 'Reviewing' },
  ];
    ...
    <div className="min-h-screen w-full relative text-white" style={{ backgroundColor: '#0d0006' }}>
      ...
      >
        <header className="flex justify-between items-center mb-6">
          <div>
            <h2 className="text-3xl font-extrabold text-white tracking-tight" style={{ fontFamily: 'Inter, sans-serif' }}>BLO Portal</h2>
            <p className="text-white/60 text-sm font-medium">Govt Official - Booth #104</p>
          </div>
          ...
          {activeTab === 'profile' && (
            ...
            >
              ...
              <div style={{ padding: '0 24px 24px 24px', textAlign: 'left' }}>
                ...
                <p style={{ color: 'rgba(255,255,255,0.6)', fontWeight: '500', fontSize: '14px', marginTop: '4px' }}>Booth Level Officer • ECI</p>
                
                <p style={{ color: 'rgba(255,255,255,0.9)', marginTop: '16px', lineHeight: '1.6', fontSize: '15px' }}>
                  Ensuring a fair and accurate electoral roll. 🏛️📜
                </p>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px', marginTop: '24px', marginBottom: '24px' }}>
                  <div style={{ backgroundColor: 'rgba(255,255,255,0.05)', borderRadius: '16px', padding: '16px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', border: '1px solid rgba(255,255,255,0.05)' }}>
                     <span style={{ fontSize: '24px', fontWeight: '900', color: '#ffffff' }}>412</span>
                     <span style={{ fontSize: '10px', color: 'rgba(255,255,255,0.5)', fontWeight: 'bold', textTransform: 'uppercase', letterSpacing: '0.1em', marginTop: '4px' }}>Approved</span>
                  </div>
                  <div style={{ backgroundColor: 'rgba(255,255,255,0.05)', borderRadius: '16px', padding: '16px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', border: '1px solid rgba(255,255,255,0.05)' }}>
                     <span style={{ fontSize: '24px', fontWeight: '900', color: '#ffffff' }}>18</span>
                  ...
                  <div style={{ padding: '16px 20px', borderRadius: '24px', backgroundColor: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.05)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                ...
                <div style={{ backgroundColor: 'rgba(255,255,255,0.05)', borderRadius: '24px', padding: '20px', border: '1px solid rgba(255,255,255,0.05)', display: 'flex', flexDirection: 'column', gap: '16px', boxShadow: 'inset 0 2px 4px 0 rgba(0, 0, 0, 0.06)' }}>
                   ...
                   <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      ...
                      <span style={{ fontFamily: 'Inter, sans-serif', fontVariantNumeric: 'tabular-nums', fontWeight: 'bold', color: '#f472b6', letterSpacing: '0.1em', fontSize: '14px' }}>XXXX XXXX 8112</span>
                   </div>
                   <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', color: 'rgba(255,255,255,0.6)' }}><Shield size={18} /> <span style={{ fontSize: '14px', fontWeight: '500' }}>ECI ID</span></div>
                      <span style={{ fontFamily: 'Inter, sans-serif', fontVariantNumeric: 'tabular-nums', fontWeight: 'bold', color: '#f472b6', letterSpacing: '0.1em', fontSize: '14px' }}>ECI-BLO-749</span>
                   </div>
                </div>
              ...
              <form onSubmit={handleAddVoter} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                ...
                <button type="submit" style={{ width: '100%', padding: '16px', borderRadius: '16px', backgroundColor: '#ec4899', color: '#fff', fontSize: '16px', fontWeight: 'bold', border: 'none', cursor: 'pointer', marginTop: '16px', boxShadow: '0 8px 16px rgba(236,72,153,0.3)', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '8px' }}>
                  <UserPlus size={20} /> Register Voter
                    ...
                    {/* 4. REQUESTS (QUEUE) TAB */}
          {activeTab === 'requests' && (
            <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} style={{ display: 'flex', flexDirection: 'column', gap: '16px', paddingBottom: '96px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
                <h3 style={{ fontSize: '28px', fontWeight: '900', color: '#fff', margin: 0, fontFamily: 'Inter, sans-serif' }}>Verification Queue</h3>
                <div style={{ padding: '6px 16px', borderRadius: '9999px', backgroundColor: 'rgba(236,72,153,0.15)', border: '1px solid rgba(236,72,153,0.3)', color: '#f472b6', fontSize: '12px', fontWeight: 'bold', textTransform: 'uppercase', letterSpacing: '0.1em' }}>
                  2 Pending
                </div>
              </div>

              {requests.map(req => (
                <div key={req.id} style={{ display: 'flex', flexDirection: 'column', padding: '24px', borderRadius: '32px', backgroundColor: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.05)', boxShadow: '0 20px 40px rgba(0,0,0,0.2)', backdropFilter: 'blur(24px)' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '20px' }}>
                    <div>
                      <h5 style={{ fontWeight: '900', color: '#fff', fontSize: '20px', margin: '0 0 4px 0', fontFamily: 'Inter, sans-serif' }}>{req.name}</h5>
                      <p style={{ fontSize: '12px', fontWeight: 'bold', textTransform: 'uppercase', letterSpacing: '0.1em', color: '#ec4899', margin: '0 0 8px 0' }}>{req.type}</p>
                      <p style={{ fontSize: '13px', color: 'rgba(255,255,255,0.5)', fontFamily: 'Inter, sans-serif', fontVariantNumeric: 'tabular-nums', margin: 0 }}>{req.epic}</p>
                    </div>
                    <span style={{ padding: '4px 12px', borderRadius: '9999px', backgroundColor: 'rgba(236,72,153,0.15)', border: '1px solid rgba(236,72,153,0.3)', color: '#f472b6', fontSize: '10px', fontWeight: 'bold', textTransform: 'uppercase', letterSpacing: '0.1em' }}>{req.status}</span>
                  </div>
                  
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '12px 16px', backgroundColor: 'rgba(236,72,153,0.05)', border: '1px solid rgba(236,72,153,0.15)', borderRadius: '16px', marginBottom: '20px', color: '#fbcfe8', fontSize: '12px', fontWeight: 'bold', textTransform: 'uppercase', letterSpacing: '0.1em' }}>
                     <UserCheck size={18} /> BLA Pre-Verified
                  </div>

                  <div style={{ display: 'flex', gap: '12px' }}>
                    <button style={{ flex: 1, padding: '16px', borderRadius: '16px', backgroundColor: '#ec4899', color: '#fff', fontSize: '14px', fontWeight: '900', border: 'none', cursor: 'pointer', boxShadow: '0 8px 16px rgba(236,72,153,0.3)', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '8px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                      <CheckCircle size={20} /> Approve
                    </button>
                    <button style={{ flex: 1, padding: '16px', borderRadius: '16px', backgroundColor: 'rgba(255,255,255,0.05)', color: '#f87171', fontSize: '14px', fontWeight: '900', border: '1px solid rgba(248,113,113,0.3)', cursor: 'pointer', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '8px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
      ...
      <div style={{ position: 'fixed', bottom: '24px', left: '50%', transform: 'translateX(-50%)', zIndex: 9999 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', backgroundColor: 'rgba(0,0,0,0.4)', backdropFilter: 'blur(24px)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '9999px', boxShadow: '0 20px 40px rgba(0,0,0,0.5), inset 0 1px 1px rgba(255,255,255,0.2)' }}>
          ...
          {/* Directory */}
          <div className="relative group cursor-pointer" onClick={() => { setActiveTab('directory'); setSelectedVoter(null); }}>
            <div style={{ width: '48px', height: '48px', borderRadius: '16px' }} className={`relative flex items-center justify-center transition-all duration-300 transform group-hover:scale-125 group-hover:-translate-y-2 z-10 ${activeTab === 'directory' ? 'bg-white/15 text-pink-400 shadow-[inset_0_1px_1px_rgba(255,255,255,0.3)]' : 'text-white/50 hover:bg-white/5 hover:text-white'}`}>
              <Search size={24} strokeWidth={activeTab === 'directory' ? 2.5 : 2} />
            </div>
            {activeTab === 'directory' && <div style={{ position: 'absolute', bottom: '-6px', left: '50%', transform: 'translateX(-50%)', width: '6px', height: '6px', borderRadius: '50%', backgroundColor: '#ec4899', boxShadow: '0 0 10px rgba(236, 72, 153,1)' }} />}
          </div>
          ...
          <div className="relative group cursor-pointer" onClick={() => setActiveTab('requests')}>
            <div style={{ width: '48px', height: '48px', borderRadius: '16px' }} className={`relative flex items-center justify-center transition-all duration-300 transform group-hover:scale-125 group-hover:-translate-y-2 z-10 ${activeTab === 'requests' ? 'bg-white/15 text-pink-400 shadow-[inset_0_1px_1px_rgba(255,255,255,0.3)]' : 'text-white/50 hover:bg-white/5 hover:text-white'}`}>
              <ListChecks size={24} strokeWidth={activeTab === 'requests' ? 2.5 : 2} />
            </div>
      ...
      {showSubModal && (
        <div style={{ position: 'fixed', inset: 0, backgroundColor: 'rgba(0,0,0,0.8)', zIndex: 10000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px' }}>
          <motion.div 
            ...
            style={{ backgroundColor: '#1a000a', borderRadius: '32px', padding: '32px', width: '100%', maxWidth: '400px', border: '1px solid rgba(236, 72, 153,0.3)', boxShadow: '0 20px 40px rgba(236, 72, 153,0.2)', textAlign: 'center' }}
          >
            ...
            {isSubscribed && <p style={{ color: '#ec4899', marginTop: '16px', fontWeight: 'bold' }}>✓ You are a Pro Member!</p>}
          </motion.div>
        </div>
      )}
